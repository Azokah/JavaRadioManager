...
public class PanelEditarPrograma extends JPanel {
	...
	public PanelEditarPrograma(MiHandler handler,String nombreProgramaAEditar) {
		super();
		this.handler = handler;
		programaJTF = new JTextField();
		programaJTF.setText(nombreProgramaAEditar);
		programaJTF.setEditable(false);
		...
		add(UIHelper.getInstance().labelNuevo("Modificar Programas",100,255,200));
		add(UIHelper.getInstance().labelNuevo(" "));
		add(UIHelper.getInstance().labelNuevo("Nombre del programa a modificar: ",255,255,255));
		add(UIHelper.getInstance().labelNuevo(" "));
		add(programaJTF);
		add(UIHelper.getInstance().labelNuevo(" "));
